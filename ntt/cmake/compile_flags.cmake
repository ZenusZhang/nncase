...
if(${CMAKE_SYSTEM_PROCESSOR} MATCHES
   ...
   if(ENABLE_K230_RUNTIME)
       #add_compile_options(-mcpu=c908v -mrvv-vector-bits=zvl -std=c++2b -fno-vectorize)
       add_compile_options(-march=rv64gcv_zvl128b_zvfh -mcpu=c908v -mrvv-vector-bits=zvl -std=c++2b -fno-vectorize)
